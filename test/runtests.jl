...
@testset "Skeleton" begin
    ...
    y = randn(N)
    ỹ = randn(M)
    skl = DPMNeal3.Skeleton(; y, ỹ)
    skl = DPMNeal3.Skeleton(; y, ỹ, a_α0, b_α0)
...
#     M, y, ygrid, v0, r0, u0, s0 = 1, [1.0], [0.0], 1.0, 1.0, 0.0, 1.0
#     m = DPMNeal3.DPMNormal(; M, y, ygrid, v0, r0, u0, s0)
#     DPMNeal3.update_suffstats!(m)
